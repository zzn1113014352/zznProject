		...
		<div class="page-container row-fluid container-fluid">
			...
			<div class="edit-con none">
				...
				<ul>
					<li class="clearfix">
						<span>公告类型:</span>
						<select name="type" id="gg_type_ss" >
							<option value="">选择类型</option>
							<option value="保洁信息">保洁信息</option>
							<option value="维修公告">维修公告</option>
						</select>
					</li>
					<li class="clearfix">
			...
			<div class="add-con none">
				...
				<ul>
					<li class="clearfix">
						<span>公告类型:</span>
						<select name="type" id="gg_type_sss" >
							<option value="">选择类型</option>
							<option value="保洁信息">保洁信息</option>
							<option value="维修公告">维修公告</option>
						</select>
...
//更新
function qd(){
var gg_type_ss = $("#gg_type_ss").val();
var content_ss = $("#content_ss").val();
if(content_ss==null || content_ss==""){
	alert("编辑内容不能为空");
	return false;
}
if(gg_type_ss==null || gg_type_ss==""){
	alert("未选择类型");
	return false;
}
var tc_id_s = $("#tc_id_s").html();
	$.ajax({
		url:"updateService.action",
...
//添加
function qdtj(){
var gg_type_s = $("#gg_type_sss").val();
var content_s = $("#content_sss").val();
if(content_s==null || content_s==""){
	alert("输入内容不能为空");
	return false;
}
if(gg_type_s==null || gg_type_s==""){
	alert("未选择类型");
	return false;
}
	$.ajax({
		url:"serviceAdd.action",
